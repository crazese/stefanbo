...
if (!empty($raw_post_data)) {
	...
	$insert['processed'] = 1;
	$makesign = md5($_SC['9ycpId'].'amount='.$insert['amount'].'callbackInfo='.$insert['callbackInfo'].'failedDesc='.$insert['failedDesc'].'gameId='.$_SC['9ygameId'].'orderId='.$insert['orderId'].'orderStatus='.$insert['orderStatus'].'payWay='.$insert['payWay'].'serverId='.$_SC['9yserverId'].'ucid='.$payInfo['ucid'].$_SC['9yapiKey']);
