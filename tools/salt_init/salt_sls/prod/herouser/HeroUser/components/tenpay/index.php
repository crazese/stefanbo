...
.tc_je span{width:100px; height:36px; float:left; line-height:36px; display:block;}
.tc_je label{float:left; width:100%;}
...
<div class="Wrap">
    ...
    <form action="<?php if($_GET['qjsh_sid'] == 'sy01'){ echo $req_domain . '?uri=index.php';} else if($_GET['qjsh_sid'] == 'sy02') {echo $req_domain_2f . '?uri=index.php';}  else if($_GET['qjsh_sid'] == 'sy03') {echo $req_domain_3f . '?uri=index.php';} else if($_GET['qjsh_sid'] == 'sy04') {echo $req_domain_4f . '?uri=index.php';} else if($_GET['qjsh_sid'] == 'sy05') {echo $req_domain_5f . '?uri=index.php';} else if($_GET['qjsh_sid'] == 'sy06') {echo $req_domain_6f . '?uri=index.php';}?>" method="post">	
    ...
    <tr><td valign="top">
      <div class="CZ">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="chongzhi">
          ...
          <tr>
            <td colspan="2"><h3 class="xzje"><?php echo $tenpay_lang['choose_amt']; ?></h3></td>
          </tr>
          <tr>
            <td colspan="2"><div class="tc_je">
            	<span><label><input name="je" type="radio" value="1" />1<?php echo $tenpay_lang['yuan'];?></label></span>
            	<span><label><input name="je" type="radio" value="10" />10<?php echo $tenpay_lang['yuan'];?></label></span>
                <span><label><input name="je" type="radio" value="20" />20<?php echo $tenpay_lang['yuan'];?></label></span>
                <span><label><input name="je" type="radio" checked="checked" value="50" />50<?php echo $tenpay_lang['yuan'];?></label></span>
                <span><label><input name="je" type="radio" value="100" />100<?php echo $tenpay_lang['yuan'];?></label></span>
                <span><label><input name="je" type="radio" value="300" />300<?php echo $tenpay_lang['yuan'];?></label></span>
                <span><label><input name="je" type="radio" value="500" />500<?php echo $tenpay_lang['yuan'];?></label></span>
                <span><label><input name="je" type="radio" value="1000" />1000<?php echo $tenpay_lang['yuan'];?></label></span>
            </div></td>
          </tr>
          <tr>
          	<td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="qttable">
              <tr>
                <td align="right"><span class="czleft"><a href="<?php if($_GET['qjsh_sid'] == 'sy01'){ echo $req_domain . '?uri=index2.php&qjsh_pid='.$pid.'&qjsh_sid='.$serverid.'&qjsh_myid='.$_GET['qjsh_myid'];} else if($_GET['qjsh_sid'] == 'sy02') {echo $req_domain_2f . '?uri=index2.php&qjsh_pid='.$pid.'&qjsh_sid='.$serverid.'&qjsh_myid='.$_GET['qjsh_myid'];} else if($_GET['qjsh_sid'] == 'sy03') {echo $req_domain_3f . '?uri=index2.php&qjsh_pid='.$pid.'&qjsh_sid='.$serverid.'&qjsh_myid='.$_GET['qjsh_myid'];} else if($_GET['qjsh_sid'] == 'sy04') {echo $req_domain_4f . '?uri=index2.php&qjsh_pid='.$pid.'&qjsh_sid='.$serverid.'&qjsh_myid='.$_GET['qjsh_myid'];} else if($_GET['qjsh_sid'] == 'sy05') {echo $req_domain_5f . '?uri=index2.php&qjsh_pid='.$pid.'&qjsh_sid='.$serverid.'&qjsh_myid='.$_GET['qjsh_myid'];} else if($_GET['qjsh_sid'] == 'sy06') {echo $req_domain_6f . '?uri=index2.php&qjsh_pid='.$pid.'&qjsh_sid='.$serverid.'&qjsh_myid='.$_GET['qjsh_myid'];} ?>"><?php echo $tenpay_lang['other_amt'];?></a></span></td>
