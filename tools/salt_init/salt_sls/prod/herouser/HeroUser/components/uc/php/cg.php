<?php
	...
	$backUrl = $_SC['backUrl'];
	$uzone_token  = isset($_GET['uzone_token']) ? urldecode($_GET['uzone_token']) : '';
	$order_no = isset($_GET['order']) ? urldecode($_GET['order']) : '';
?>
...
<div class="Wrap">
    ...
    <div class="Main">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ListTable">
          <tr>
            <td align="center"><h3>充值订单(<?php echo $order_no; ?>)已成功提交，正在处理中，请稍后重新登录游戏！如10分钟后仍未到账，请电话联系客服027-59715110</h3></td>
          </tr>
          <tr>
            <td align="center"><a href="<?php echo 'http://117.135.138.196/index.php?uzone_token=' . base64_decode($uzone_token) ?>"><img class="fhbtn" src="Images/fh.jpg" width="50" height="28" /></a></td>
          </tr>
        </table>
        </div>
    </div>
