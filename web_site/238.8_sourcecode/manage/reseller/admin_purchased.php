<?php
  ...
  $end = substr($end,0,10); 
  $page=new page(array('total'=>intval($total),'perpage'=>intval($perpage),'url'=>'admin_purchased.php','page_name'=>'ProductName='.$ProductID.'&email='.$email.'&from='.$from.'&ResellerID='.$ResellerID.'&end='.$end.'&page','nowindex'=>$page));
...
<script language="JavaScript" type="text/javascript">
   function purchased()
   {
      document.form2.action='admin_purchased.php';
   }
   function exportemail()
   {
      document.form2.action='admin_export.php';
   } 
    ...
    <tr>
      <td>Product Name:
	   ...
	   ?>
        ...
        <input name="Export" type="submit" id="Export" value="Export" onClick="exportemail()">
        <input name="ResellerID" type="hidden" id="ResellerID" value="<?php echo $ResellerID;?>" />
        <input name="uname" type="hidden" id="uname" value="<?php echo $_GET['uname'];?>" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
