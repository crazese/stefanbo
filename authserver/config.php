<?php
$_SC = array();
$_SC['dbhost']  		= 'localhost'; //数据库服务器地址
$_SC['dbuser']  		= 'auth';   //数据库用户名
$_SC['dbpw'] 	 		= '123456';   //数据库密码
$_SC['dbname']			= 'authserver';

//$MemcacheList = array('192.168.1.5'); //Memcache服务器列表
//$Memport = 11211;

define('WS_SERVER', 'http://192.168.1.5:9090/');
define('KEY_PATH', 'e:/key');
define('WS_CLIENT', "192.168.2.91,127.0.0.1"); // 后台管理服务器的地址
//define("SMS_ADDR", 'http://192.168.1.9:8090/sms.asp');
define("SMS_ADDR", 'http://119.97.231.194:5218/sms.asp');
define('SMS_KEY', '123456'); // 短信网关加密key
define('DEBUG', 1); // 正式环境设为0
/*UC游戏接口相关信息*/
$_SC['cpId'] = 690;
$_SC['gameId'] = 64431;
$_SC['channelId'] = 2;
...
$_SC['ucsynUrl'] = 'hud.jofgame.com';  //uc官方账号登陆同步地址
$_SC['port'] = 9000;                   //uc官方账号登陆同步端口
...
class Rsa
{
        ...
        public function __construct($path)
        {
                if(empty($path) || !is_dir($path)){
                        throw new Exception('Need a DIRECTORY PATH form keys save');
                }
