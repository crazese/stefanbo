...
$appKey = 'UCH0yf60G3x8YN829s2Q39MB';
$appSecret = 'QNEdWUEdo3xQm43lPcucKqwV';
...
if ($signStr == $GET['signStr']) {
	...
	if ($gameid != $_SC['fwqdm']) {
		if ($gameid == 'zyy02') {
			zfsj('http://sop2.jofgame.com/ucpay/azpay.php',$_REQUEST);
			exit;
		} elseif ($gameid == 'zjsh_zyy_001') {
			zfsj('http://zj01.jofgame.com/ucpay/azpay.php',$_REQUEST);
			exit;
		} elseif ($gameid == 'zyy03') {
			zfsj('http://sop3.jofgame.com/ucpay/azpay.php',$_REQUEST);
			exit;
		}
	}	
