...
$userid = $fwqInfo[1];
if ($gameid != $_SC['fwqdm']) {	
	$_REQUEST['ext'] = urldecode($_REQUEST['ext']);	
	if ($gameid == 'zyy02') {	
		zfsj('http://sop1.jofgame.com/pay/dlpay.php',$_REQUEST);
		exit;
	} elseif ($gameid == 'zjsh_zyy_001') {
		zfsj('http://zj01.jofgame.com/pay/dlpay.php',$_REQUEST);
		exit;
	} elseif ($gameid == 'zyy03') {
		zfsj('http://sop3.jofgame.com/pay/dlpay.php',$_REQUEST);
		exit;
	} elseif ($gameid == 'zj3') {
		zfsj('http://117.135.139.237:8080/pay/dlpay.php',$_REQUEST);
		exit;
	}
}
