...
ini_set("xhprof.output_dir", dirname(__FILE__) . '/../xhprof_log/'.$dir);
...
echo '<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>XHProf: Hierarchical Profiler Report</title>';
