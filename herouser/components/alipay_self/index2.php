...
<div class="Wrap">
    ...
    <form action="<?php echo $req_domain . 'index2.php'; ?>" method="post">
    <div class="Main">
      <div class="CZ">
        ...
        <div class="fhbtn"><a href="<?php echo $req_domain . 'index.php?qjsh_pid='.$pid.'&qjsh_sid='.$serverid; ?>"><!--<div class="fhbtn"><a href="<?php echo $merchant_url ?>">--><img src="Images/fh.jpg" width="50" height="28" /></a></div>
