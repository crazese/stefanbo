...
<div class="Wrap">
    ...
    <form action="<?php if($_GET['sid'] == 'sy01'){ echo $req_domain . '?uri=index2.php';} else if($_GET['sid'] == 'sy02') {echo $req_domain_2f . '?uri=index2.php';} else if($_GET['sid'] == 'sy03'){echo $req_domain_3f . '?uri=index2.php';} else if($_GET['sid'] == 'sy04'){echo $req_domain_4f . '?uri=index2.php';} else if($_GET['sid'] == 'sy05'){echo $req_domain_5f . '?uri=index2.php';} else if($_GET['sid'] == 'sy06'){echo $req_domain_6f . '?uri=index2.php';} ?>" method="post">
    <div class="Main">
      <div class="CZ">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="chongzhi">
          ...
          <tr>
            <td colspan="2"><h3 class="xzje"><?php echo $alipay_lang['input_amt']; ?></h3></td>
          </tr>        
          <tr>
        ...
        <div class="fhbtn"><a href="<?php if($_GET['sid'] == 'sy01'){ echo $req_domain . '?uri=index.php&pid='.$pid.'&sid='.$serverid;} else if($_GET['sid'] == 'sy02') {echo $req_domain_2f . '?uri=index.php&pid='.$pid.'&sid='.$serverid;} else if($_GET['sid'] == 'sy03') {echo $req_domain_3f . '?uri=index.php&pid='.$pid.'&sid='.$serverid;} else if($_GET['sid'] == 'sy04') {echo $req_domain_4f . '?uri=index.php&pid='.$pid.'&sid='.$serverid;} else if($_GET['sid'] == 'sy05') {echo $req_domain_5f . '?uri=index.php&pid='.$pid.'&sid='.$serverid;} else if($_GET['sid'] == 'sy06') {echo $req_domain_6f . '?uri=index.php&pid='.$pid.'&sid='.$serverid;}?>"><!--<div class="fhbtn"><a href="<?php echo $merchant_url ?>">--><img src="Images/fh.jpg" width="50" height="28" /></a></div>
