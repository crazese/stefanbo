...
$key_path = '/usr/local/app/lnmp/key/';  // 修改1 放入.pem文件

$notify_url		= "notify_url.php";	 
$call_back_url	= "callback_url.php";	

//↓↓↓↓↓↓↓↓↓↓杜欢这里需要修改↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
$req_domain = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay-1.php'; // 正式环境     修改2
$req_domain_2f = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay-2.php'; // 正式环境 修改2
$req_domain_3f = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay-3.php'; // 正式环境 修改2
$req_domain_4f = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay-4.php';
$req_domain_5f = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay-5.php';
$req_domain_6f = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay-6.php';

//$req_domain = 'http://221.181.193.84:8099/proxy/reqProxy_alipay980-1.php'; // 测试环境
//$req_domain_2f = 'http://221.181.193.84:8099/proxy/reqProxy_alipay980-2.php'; // 测试环境
