...
<div class="Wrap">
    ...
    <div class="Main">
        ...
        <?php
        	if($post_type == '') {
        		echo "<input name='type' type='hidden' id='type' value='1' />";
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ListTable">
          <tr>
            <td>
            <div class="jine"><label><input name="sel" type="radio" value="10" checked="checked" />10元</label> <label><input name="sel" type="radio" value="20" />20元</label> <label><input name="sel" type="radio" value="30" />30元</label> <label><input name="sel" type="radio" value="50" />50元</label> <label><input name="sel" type="radio" value="100" />100元</label> <br /><label><input name="sel" type="radio" value="300" />300元</label> <label><input name="sel" type="radio" value="500" />500元</label></div>
            <p align="center"><span class="green">10</span>元人民币将兑换<span class="green">100</span>元宝</p>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ListTable">
          <tr>
            <td colspan="3" align="center"><h3>请输入移动充值卡卡号和密码</h3></td>
          </tr>
          <tr>
