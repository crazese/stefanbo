...
function annulCard($p2_Order,$p3_Amt,$p4_verifyAmt,$p5_Pid,$p6_Pcat,$p7_Pdesc,$p8_Url,$pa_MP,$pa7_cardAmt,$pa8_cardNo,$pa9_cardPwd,$pd_FrpId,$pz_userId,$pz1_userRegTime)
{
	...
	if(SYPT == 1) {
		$pageContents = HttpClient::quickPost('http://'.SY_PROXY_INTRANET_IP.'/proxy/payProxy.php', $params);		
	} else {
		$pageContents	= HttpClient::quickPost('https://www.yeepay.com/app-merchant-proxy/command.action', $params);
	}
