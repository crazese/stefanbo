...
$req_domain = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay980-1.php'; // 测试环境
$req_domain_2f = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay980-2.php'; // 测试环境
$req_domain_3f = 'http://'.SY_PROXY_INTERNET_IP.'/proxy/reqProxy_alipay980-3.php'; // 测试环境
