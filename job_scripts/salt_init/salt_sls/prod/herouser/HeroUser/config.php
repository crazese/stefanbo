...
$_SC['dbuser']= 'hero';   //数据库用户名
$_SC['dbpw']= '123456';   //数据库密码
$_SC['fwqdm']           = 'hud';  //自定义服务器代码 (九游 1服)
$_SC['dbname']= 'hero';      //数据库名称
...
$_SC['port']= 80;
$_SC['domain'] = '192.168.1.204';        //cookie域,与当前服务器域名一致即可，不可带http://
...
define('SY_PROXY_INTRANET_IP', '10.144.133.54:8099'); // 闪游充值网关内网IP
define('SY_PROXY_INTERNET_IP', '221.181.193.82:8099'); // 闪游充值网关外网IP 还需要同步修改q.jofgame.com的zfb_check.php
...
$_TASK = array("common"  => array ( "a" => "version"),
			   ...
			   "dalei" => array("a" => "hqltxx","b"=>"wdph","c"=>"qybm","d"=>"tsjw","e"=>"wdph10","f"=>"dlt","g"=>"dhcl","h"=>"zjcs","i"=>"jscd","j"=>"lthf",'k'=>'sxds','l'=>'hqdlzr','m'=>'dhlb','n'=>'dh','o'=>'pm','p'=>'lqxt'),
